...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> LIT_WATER = registerLitBlock(Blocks.WATER, LitWaterBlock::new);
    ...
    private static <T extends LitFlowerBlock> RegistryObject<T> registerLitFlowerBlock(Block vanillaBlock, Function<FlowerBlock, T> litBlockFunc) {
